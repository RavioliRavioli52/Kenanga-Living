...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $products = [
            ...
            [
                'id_categories' => 5,
                'nama_products' => 'Tempat Tidur 1',
                'deskripsi_products' => 'Tempat tidur queen size.',
                'harga' => 5500000,
                'stok' => 6,
                'gambar' => 'shop_07.jpg',
            ],
            [
                'id_categories' => 5,
                'nama_products' => 'Tempat Titudr 2',
                'deskripsi_products' => 'Tempat tidur king size.',
                'harga' => 4800000,
                'stok' => 4,
                'gambar' => 'shop_08.jpg',
            ],
            [
                'id_categories' => 3,
                'nama_products' => 'Lemari',
                'deskripsi_products' => 'Lemari kayu.',
                'harga' => 8500000,
                'stok' => 3,
                'gambar' => 'shop_09.jpg',
            ],
