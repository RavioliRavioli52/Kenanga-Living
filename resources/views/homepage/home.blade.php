        ...
        <div class="container py-5">
            ...
            <div class="row">
                <div class="col-4 mb-4">
                    <div class="card h-100">
                        <a href="{{ route('shop-single') }}" class="text-decoration-none">
                            <img src="{{ asset('assets/img/feature_prod_01.jpg') }}" class="card-img-top" alt="Gym Weight">
                        </a>
                        <div class="card-body">
                ...
                <div class="col-4 mb-4">
                    <div class="card h-100">
                        <a href="{{ route('shop-single') }}" class="text-decoration-none">
                            <img src="{{ asset('assets/img/feature_prod_02.jpg') }}" class="card-img-top" alt="Cloud Nike Shoes">
                        </a>
                        <div class="card-body">
                            <ul class="list-unstyled d-flex justify-content-between">
                                <li>
